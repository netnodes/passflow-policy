...
- ensuring your developers and contractors comply with this Agreement
...
- comply with all applicable laws, including privacy and data-protection laws such as GDPR  
- follow all technical documentation and integration guidance  
- obtain all necessary rights and permissions from your end users  
- maintain security appropriate to the sensitivity of the data you process
...
- only send lawful, authorised data to the PassFlow API  
- implement technical and organisational measures to protect personal data  
- comply with the PassFlow Privacy Notice and any data-processing terms we make available  
- promptly delete data that you no longer require  
- notify us without undue delay if you discover a security incident involving the Developer Services
...
- store keys only in secure, server-side environments  
- rotate keys if you suspect compromise  
- use industry-standard encryption for data in transit and at rest  
- prevent unauthorised use of your integration
...
- use PassFlow’s name, logos, or branding without written permission  
- imply partnership, endorsement, or certification  
- modify or create derivative works of PassFlow trademarks
...
- misuse the Developer Services  
- fail to pay applicable fees

Upon termination, you must:  

- stop using the Developer Services  
...
- does not create a partnership, agency, or employment relationship  
- may not be assigned without our written consent  
- remains valid even if one clause is found unenforceable
